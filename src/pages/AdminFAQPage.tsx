...
import Table from '../components/Table/Faq/Table';
import Pagination from '../components/Table/Faq/Pagination';
import Modal from '../components/Table/Faq/Modal';
import { RowData } from '../components/Table/Faq/types';
import { fetchData, addRow, updateRow, deleteRow } from '../components/Table/Faq/api';
